...
Public Class EthernetIPforCLXCom
    ...
    Public Event Disposed As EventHandler Implements ComponentModel.IComponent.Disposed
...
#Region "Constructor"
    ...
    Public Overloads Sub dispose() Implements ComponentModel.IComponent.Dispose
        MyBase.Dispose(True)
        GC.SuppressFinalize(Me)
    End Sub

    Protected Overloads Sub Dispose(disposing As Boolean) 'Implements ComponentModel.IComponent.Dispose
        If disposing Then
            SyncLock Me
...
#Region "Properties"
    ...
    Public Overridable Property Site() As System.ComponentModel.ISite Implements ComponentModel.IComponent.Site
        Get
            Return m_site
        End Get
