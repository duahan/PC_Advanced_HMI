            ...
            If (value IsNot Nothing) And m_CommComponent Is Nothing Then
                If MyBase.Site.DesignMode Then
                    ...
                    While m_CommComponent Is Nothing And i < Me.Site.Container.Components.Count
                        ...
                        If Me.Site.Container.Components(i).GetType.GetInterface("IComComponent") IsNot Nothing Then
                            m_CommComponent = DirectCast(Me.Site.Container.Components(i), MfgControl.AdvancedHMI.Drivers.IComComponent)
                        End If
                        i += 1
                    End While
        ...
        If Not DesignMode Then
            ...
            For index = 0 To m_PLCAddressValueItems.Count - 1
                If Not String.IsNullOrEmpty(m_PLCAddressValueItems(index).PLCAddress) Then
                    ...
                    SubScriptions.SubscribeTo(m_PLCAddressValueItems(index).PLCAddress, m_PLCAddressValueItems(index).NumberOfElements, AddressOf PolledDataReturned, m_PLCAddressValueItems(index).PLCAddress)
