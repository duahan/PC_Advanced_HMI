...
#Region "Properties"
    ...
    Public Property PLCNumberOfElements As Integer
        ...
        Set(value As Integer)
            m_PLCNumberOfElements = Math.Min(8, value)
...
#Region "Constructor/Destructor"
    ...
    Protected Overrides Sub Dispose(ByVal disposing As Boolean)
        Try
            If disposing Then
                m_CommComponent.Unsubscribe(NotificationIDValue)
                If SubScriptions IsNot Nothing Then
...
#Region "Subscribing and PLC data receiving"
    ...
    Private Sub SubscribeToCommDriver()
        If Not DesignMode And IsHandleCreated Then
            ...
            NotificationIDValue = m_CommComponent.Subscribe(m_PLCAddressValues, m_PLCNumberOfElements, 500, AddressOf PolledDataReturned)
        End If
    End Sub
