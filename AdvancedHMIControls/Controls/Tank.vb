...
'****************************************************************************
Public Class Tank
    Inherits MfgControl.AdvancedHMI.Controls.Tank
...
#Region "Keypad popup for data entry"
    ...
    Private Sub KeypadPopUp_ButtonClick(ByVal sender As Object, ByVal e As MfgControl.AdvancedHMI.Controls.KeyPadEventArgs) Handles KeypadPopUp.ButtonClick
        ...
        ElseIf e.Key = "Enter" Then
            If m_CommComponent IsNot Nothing And (KeypadPopUp.Value IsNot Nothing AndAlso (String.Compare(KeypadPopUp.Value, "") <> 0)) Then
