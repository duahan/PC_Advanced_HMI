...
'*
'* 19-OCT-11 Created
'* 05-JUN-13 Added FileReadError handler
'****************************************************************************
Public Class MessageDisplayByValue
    Inherits MfgControl.AdvancedHMI.Controls.MessageDisplayByValue
...
#Region "Events"
    ...
    Private Sub MessageDisplayByValue_FileReadError(sender As Object, e As System.EventArgs) Handles Me.FileReadError
        PLCAddressValue = ""
    End Sub
#End Region
