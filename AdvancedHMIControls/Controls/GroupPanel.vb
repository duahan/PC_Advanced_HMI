...
Public Class GroupPanel
    Inherits MfgControl.AdvancedHMI.Controls.GroupPanel
...
#Region "PLC Related Properties"
    ...
    '*************************************************************
    Private m_PLCAddressSelectBackColor2 As String = ""
    <System.ComponentModel.Category("PLC Properties")> _
    <System.ComponentModel.DefaultValue("")> _
    Public Property PLCAddressSelectBackColor2() As String
        Get
            Return m_PLCAddressSelectBackColor2
        End Get
        Set(ByVal value As String)
            If m_PLCAddressSelectBackColor2 <> value Then
                m_PLCAddressSelectBackColor2 = value
        ...
        If Me.DesignMode Then
            ...
            While m_CommComponent Is Nothing And i < j
                If Me.Parent.Site.Container.Components(i).GetType.GetInterface("IComComponent") IsNot Nothing Then
                    m_CommComponent = CType(Me.Parent.Site.Container.Components(i), MfgControl.AdvancedHMI.Drivers.IComComponent)
                End If
                i += 1
            End While
