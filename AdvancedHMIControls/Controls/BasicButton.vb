...
#Region "Events"
    ...
    Private Sub MomentaryButton_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseDown
        ...
        If (m_PLCAddressClick IsNot Nothing AndAlso (String.Compare(m_PLCAddressClick, "") <> 0)) AndAlso m_CommComponent IsNot Nothing Then
            Try
                Select Case _OutputType
                    Case MfgControl.AdvancedHMI.Controls.OutputType.MomentarySet
                        m_CommComponent.BeginWrite(m_PLCAddressClick, 1, New String() {"1"})
                    ...
                    Case MfgControl.AdvancedHMI.Controls.OutputType.MomentaryReset
                        m_CommComponent.BeginWrite(m_PLCAddressClick, 1, New String() {"0"})
                        If m_MinimumHoldTime > 0 Then MinHoldTimer.Enabled = True
                        If m_MaximumHoldTime > 0 Then MaxHoldTimer.Enabled = True
                    Case MfgControl.AdvancedHMI.Controls.OutputType.SetTrue : m_CommComponent.BeginWrite(m_PLCAddressClick, 1, New String() {"1"})
                    Case MfgControl.AdvancedHMI.Controls.OutputType.SetFalse : m_CommComponent.BeginWrite(m_PLCAddressClick, 1, New String() {"0"})
                    ...
                    Case MfgControl.AdvancedHMI.Controls.OutputType.WriteValue
                        m_CommComponent.BeginWrite(m_PLCAddressClick, 1, New String() {m_ValueToWrite})
                End Select
