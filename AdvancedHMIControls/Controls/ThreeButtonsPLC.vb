    ...
    Protected Overrides Sub Dispose(ByVal disposing As Boolean)
        Try
            If disposing And m_CommComponent IsNot Nothing Then
                m_CommComponent.UnSubscribe(NotificationIDAutoStatus)
                m_CommComponent.UnSubscribe(NotificationIDHandStatus)
                m_CommComponent.UnSubscribe(NotificationIDOffStatus)
                m_CommComponent.UnSubscribe(NotificationIDVisibility)
            End If
        Finally
            ...
            If PLCAddress IsNot Nothing AndAlso (String.Compare(PLCAddress, "") <> 0) Then
                Try
                    If m_CommComponent IsNot Nothing Then
                        NotificationID = m_CommComponent.Subscribe(PLCAddress, 1, 250, callBack)
