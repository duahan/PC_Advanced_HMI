...
Public Class SelectorSwitch
    Inherits MfgControl.AdvancedHMI.Controls.SelectorSwitch
...
#Region "Events"
    ...
    Protected Overrides Sub OnCreateControl()
        ...
        If Me.DesignMode Then
            ...
            '*********************************************
            If m_CommComponent Is Nothing And (m_PLCAddressClick IsNot Nothing AndAlso (String.Compare(m_PLCAddressClick, "") <> 0)) Then
